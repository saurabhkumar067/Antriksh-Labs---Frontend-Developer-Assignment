  ...
  return (
    <div className="lg:px-2 min-[1300px]:py-1 md:py-0 h-full overflow-hidden min-[320px]:px-0">
      <h3 className="font-semibold md:text-base min-[320px]:text-xs min-[320px]:pl-3 md:pl-0">
        ...
        <span className="text-[#647297] font-bold">(10 tasks)</span>
      </h3>
      ...
      >
        <div className="xl:h-[31%] lg:h-[28%]  lg:w-full md:w-[97%] min-[320px]:w-[60%]">
          <div className="uppercase md:fixed xl:px-6 min-[1300px]:h-[25.5%] xl:h-[25%] lg:h-[24%] lg:w-6 md:h-[10%] md:w-[28.5%] tracking-widest bg-white font-bold flex lg:flex-col min-[320px]:flex-row items-center justify-center border border-black rounded-xl">
          ...
          <div className="toDoCards lg:ml-20 xl:ml-16 md:mt-16  lg:mt-0 md:pt-0 w-full gap-4 lg:flex h-full lg:flex-nowrap ">
           ...
           (Pending.map((item)=>{
              return (
                <Cards key={item.id} id={item.id} disc={item.description}/>
              )
            }))}
          </div>
        </div>
        ...
        <div className="min-[1300px]:my-4  lg:my-3 xl:h-[31%] lg:h-[28%] md:w-[97%] min-[320px]:w-[80%]">
          ...
          <div className="uppercase md:fixed xl:px-6  min-[1300px]:h-[25.5%] xl:h-[25%] lg:h-[24%] md:h-[10%] lg:w-0 md:w-[28.5%] bg-white tracking-widest font-bold flex lg:flex-col md:flex-row items-center justify-center border border-black  rounded-xl">
        ...
        <div className="xl:h-[31%]   lg:h-[28%] md:w-[97%] min-[320px]:w-[80%]">
          <div className="uppercase md:fixed xl:px-6 min-[1300px]:h-[25.5%] xl:h-[25%] lg:h-[24%] md:h-[10%] lg:w-0 md:w-[29%] tracking-widest bg-white font-bold flex lg:flex-col md:flex-row rounded-xl items-center justify-center border border-black">
